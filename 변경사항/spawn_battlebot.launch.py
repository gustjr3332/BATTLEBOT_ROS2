...
def generate_launch_description():
    ...
    urdf_file_1 = os.path.join(pkg_share, 'urdf', 'battlebot_1.urdf')
    ...
    battlebot_1_rsp_node = Node(
        ...
        name='battlebot1_state_publisher',
    ...
    spawn_battlebot_1_entity = TimerAction(
        ...
        actions=[
            Node(
                ...
                arguments=[
                    '-entity', 'battlebot_1',  # URDF의 <robot name="battlebot">과 일치
                    '-file', urdf_file_1,
                    '-x', '0', '-y', '4', '-z', '0.3'
                ],
                output='screen'
